        ...
        <div className="max-w-4xl mx-auto glass-strong rounded-2xl overflow-hidden border border-neon-teal/20">
          <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              {/* Connect with Priyanshu - Social Links - PROMINENT */}
              <div className="mb-6 p-5 rounded-xl bg-gradient-to-br from-neon-teal/10 to-neon-blue/10 border-2 border-neon-teal/30">
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <a
                    ...
                    className="group flex items-center gap-3 px-5 py-3.5 rounded-xl bg-[#0A66C2]/20 hover:bg-[#0A66C2]/30 border-2 border-[#0A66C2]/50 hover:border-[#0A66C2] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(10,102,194,0.4)]"
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-bold text-white group-hover:text-[#0A66C2] transition-colors">LinkedIn</p>
                      <p className="text-xs text-metal-grey">Professional Network</p>
                    </div>
                    <svg className="w-5 h-5 text-[#0A66C2] group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-3 px-5 py-3.5 rounded-xl bg-gradient-to-br from-[#833AB4]/20 via-[#E1306C]/20 to-[#F77737]/20 hover:from-[#833AB4]/30 hover:via-[#E1306C]/30 hover:to-[#F77737]/30 border-2 border-[#E1306C]/50 hover:border-[#E1306C] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(225,48,108,0.4)]"
                  >
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      <p className="font-bold text-white group-hover:text-[#E1306C] transition-colors">Instagram</p>
                      <p className="text-xs text-metal-grey">@iam_priyanshushukla</p>
                    </div>
                    <svg className="w-5 h-5 text-[#E1306C] group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-3 px-5 py-3.5 rounded-xl bg-white/10 hover:bg-white/20 border-2 border-white/30 hover:border-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-bold text-white transition-colors">GitHub</p>
                      <p className="text-xs text-metal-grey">Open Source Projects</p>
                    </div>
